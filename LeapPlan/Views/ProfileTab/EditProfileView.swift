        ...
        NavigationStack {
            Form {
                    ...
                    HStack {
                        ...
                        VStack(spacing: 12) {
                            ...
                            HStack(spacing: 20) {
                                ...
                                if viewModel.editProfileImageBase64 != nil
                                    || selectedUIImage != nil
                                {
                                    Button(
                                        role: .destructive,
                ...
                Section(header: Text("Personal Info")) {
                    ...
                    TextField("Email", text: $viewModel.editEmail).keyboardType(
                        .emailAddress
                ...
                Section(
                    ...
                    footer: Text(
                        "Leave new password empty if you don't want to change it. Current password is required to save email/password changes."
                    )
                ) {
                    SecureField(
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    if viewModel.isLoading {
                        ...
                        Button("Save") {
                            Task {
                                let success = await viewModel.saveEditedProfile(
