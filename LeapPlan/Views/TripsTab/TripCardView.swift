        ...
        ZStack(alignment: .bottomLeading) {
            ...
            VStack(alignment: .leading, spacing: 0) {
                HStack {
                    if placesCount > 0 {
                        HStack(spacing: 4) {
                            ...
                            Text("\(placesCount) Places").font(.caption.bold())
                    ...
                    Spacer()
                    Text(trip.status.rawValue).font(.caption.bold())
                        .foregroundColor(.white)
                        .padding(.horizontal, 14).padding(.vertical, 8)
                        .background(Color.leapPrimary).clipShape(Capsule())
                }
                Spacer()
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text(trip.title).font(.title2).fontWeight(.bold)
